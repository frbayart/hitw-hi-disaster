...
export class MockBackendService extends BackendService {
  ...
  public getDisasters(disasterZone: DisasterZone): Observable<DisasterResult> {
    const disasterResult = new DisasterResult();
    disasterResult.results = [new Disaster()];
